...
const API_KEY = process.env.YT_MUSIC_API_KEY || 'AIzaSyAO_FJ2SlqU8Q4STEHLGCilw_Y9_11qcW8';
...
module.exports = async (req, res) => {
    ...
    try {
        ...
        const result = { status: true, input: { id: artistId }, result: { artistId, name, thumbnails, topSongs, topAlbums, topSingles, topVideos, playlists, featuredOn, similarArtists, creator: 'Rikiz' } };
