var Home = {
    ...
    render() {
        ...
        <div class="pt-8 pb-3.5 px-4 sticky top-0 z-30 border-b border-white/10 shadow-2xl transition-all relative overflow-hidden" style="background: linear-gradient(180deg, rgba(8,9,13,0.55) 0%, rgba(8,9,13,0.88) 100%), url('/banner.png') center/cover no-repeat; backdrop-filter: blur(14px); -webkit-backdrop-filter: blur(14px);">
            ...
            <div class="flex justify-between items-center mb-3 relative z-10">
                ...
                <div class="flex items-center gap-2.5">
                    ...
                    <button onclick="App.switch('dev')" class="w-10 h-10 rounded-2xl flex items-center justify-center text-[#050608] active:scale-95 transition-all" title="Profil" style="background:linear-gradient(135deg,var(--accent),var(--accent-2)); box-shadow: 0 6px 18px rgba(var(--accent-rgb),0.4);">
            ...
            <div class="glass-strong rounded-3xl p-5 border border-white/15 bg-gradient-to-br from-white/10 via-white/5 to-transparent relative overflow-hidden ">
                <div class="flex flex-col sm:flex-row items-center sm:items-start gap-4 text-center sm:text-left relative z-10">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xs text-[#b3b3b3] mt-1 leading-relaxed">Pengembang & Pembuat MusifyRik. Selamat menikmati streaming musik favorit tanpa gangguan!</p>
    ...
    show() {
        ...
        if (rec && recSection) {
            ...
            if (recent.length > 0) {
                ...
                rec.innerHTML = recent.slice(0, 10).map(function(t, i){
                    return '<div onclick="PK(\'recent\',' + i + ')" class="flex-shrink-0 w-36 cursor-pointer active:scale-95 group p-2.5 rounded-2xl bg-[#20222c] border border-white/10 shadow-xl hover:bg-[#282b38] transition-all flex flex-col">' +
        ...
        if ((!S.ht || S.ht.length === 0) && !navigator.onLine) {
            ...
            g.innerHTML = '<div class="col-span-2 md:col-span-4 bg-[#20222c] border border-white/10 rounded-2xl p-5 text-center space-y-3 shadow-xl">' +
