var Artist={
    init(){
        ...
        <div id="artist-modal" class="fixed inset-0 bg-[#141413] flex flex-col z-30" style="display:none; animation: slideUp 0.3s ease-out forwards;">
            ...
            if(d.status && d.result){
                ...
                if(a.topAlbums&&a.topAlbums.length>0){
                    ...
                    a.topAlbums.forEach(function(al){
                        ...
                        html+=`
                        <div onclick="Album.open('${al.browseId}', '${esJs(im)}')" class="flex-shrink-0 w-36 cursor-pointer group p-2 rounded-2xl bg-[#2a2521] border border-white/10 shadow-xl hover:bg-[#363230] transition-all">
                ...
                if(a.topSingles&&a.topSingles.length>0){
                    ...
                    a.topSingles.forEach(function(sg){
                        ...
                        html+=`
                        <div onclick="Album.open('${sg.browseId}', '${esJs(im)}')" class="flex-shrink-0 w-36 cursor-pointer group p-2.5 rounded-2xl bg-[#2a2521] border border-white/10 shadow-xl hover:bg-[#363230] transition-all flex flex-col">
                            <div class="w-full aspect-square rounded-xl overflow-hidden mb-2 shadow-md">
                                <img src="${im}" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" onerror="this.src='${FI}'" />
                            </div>
                ...
                if(a.topVideos&&a.topVideos.length>0){
                    ...
                    a.topVideos.forEach(function(vd){
                        ...
                        html+=`
                        <div onclick="Artist.play('${vd.videoId||''}','${esJs(vd.name)}','${esJs(vd.artist||a.name)}','${esJs(im)}')" class="flex-shrink-0 w-48 cursor-pointer group p-2.5 rounded-2xl bg-[#2a2521] border border-white/10 shadow-xl hover:bg-[#363230] transition-all flex flex-col">
                ...
                if(a.playlists&&a.playlists.length>0){
                    ...
                    a.playlists.forEach(function(pl){
                        ...
                        html+=`
                        <div onclick="Album.open('${pl.browseId}', '${esJs(im)}')" class="flex-shrink-0 w-36 cursor-pointer group p-2.5 rounded-2xl bg-[#2a2521] border border-white/10 shadow-xl hover:bg-[#363230] transition-all flex flex-col">
                            <div class="w-full aspect-square rounded-xl overflow-hidden mb-2 shadow-md">
                                <img src="${im}" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" onerror="this.src='${FI}'" />
                            </div>
                ...
                if(a.featuredOn&&a.featuredOn.length>0){
                    ...
                    a.featuredOn.forEach(function(fo){
                        ...
                        html+=`
                        <div onclick="Album.open('${fo.browseId}', '${esJs(im)}')" class="flex-shrink-0 w-36 cursor-pointer group p-2.5 rounded-2xl bg-[#2a2521] border border-white/10 shadow-xl hover:bg-[#363230] transition-all flex flex-col">
                            <div class="w-full aspect-square rounded-xl overflow-hidden mb-2 shadow-md">
                                <img src="${im}" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" onerror="this.src='${FI}'" />
                            </div>
                ...
                if(a.similarArtists&&a.similarArtists.length>0){
                    ...
                    a.similarArtists.forEach(function(s){
                        ...
                        html+=`
                        <div onclick="Artist.open('${s.browseId}','${esJs(s.name)}')" class="flex-shrink-0 w-32 cursor-pointer group p-2.5 rounded-2xl bg-[#2a2521] border border-white/10 shadow-xl hover:bg-[#363230] transition-all flex flex-col items-center">
    ...
    share() {
        ...
        if (navigator.share) {
            navigator.share({
                title: name + ' - MusifyRik',
                text: 'Dengarkan lagu & album terbaik dari ' + name + ' di MusifyRik!',
                url: url
            }).catch(function() {});
        } else {
