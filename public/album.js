var Album = {
    init() {
        ...
        <div id="album-modal" class="fixed inset-0 bg-[#0d0d0c] flex flex-col z-[100]" style="display:none; animation: slideUp 0.3s ease-out forwards;">
    ...
    share(id) {
        ...
        if (navigator.share) {
            navigator.share({
                title: title + ' - MusifyRik',
                text: 'Dengarkan album ' + title + ' di MusifyRik!',
                url: url
            }).catch(function() {});
        } else {
