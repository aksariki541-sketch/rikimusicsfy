var Search={
    render(){
        ...
        <div class="pt-8 pb-3.5 px-4 sticky top-0 z-30 border-b border-white/10 shadow-2xl transition-all relative overflow-hidden" style="background: linear-gradient(180deg, rgba(8,9,13,0.55) 0%, rgba(8,9,13,0.9) 100%), url('/banner.png') center/cover no-repeat; backdrop-filter: blur(14px); -webkit-backdrop-filter: blur(14px);">
            ...
            <form id="search-form" class="relative z-10" autocomplete="off">
                ...
                <button type="submit" id="search-submit-btn" class="absolute right-1.5 top-1/2 -translate-y-1/2 text-[#050608] font-extrabold px-4 py-2.5 rounded-xl active:scale-90 transition-all" style="background:linear-gradient(135deg,var(--accent),var(--accent-2)); box-shadow:0 6px 16px rgba(var(--accent-rgb),0.4);">Cari</button>
            </form>
